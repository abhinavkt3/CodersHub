        ...
        <div className="row">
          <div className="col col--6">
            ...
            <p className={styles.aboutUsDescription}>
              Welcome to Coders Hub, your go-to destination for quality tech education. At Coders Hub, we are passionate about empowering individuals with the knowledge and skills needed to thrive in the ever-evolving world of technology.
            </p>
            <p className={styles.aboutUsDescription}>
