...
const featuresData = [
  {
    ...
    title: "Blog Posts",
    description: "Read the latest blog posts shared by the CodersHub.",
  },
  {
    icon: "/img/svg/browsing.svg",
    title: "Browse Courses",
    description:
      "Browse through the courses and tutorials shared by the CodersHub.",
  },
  {
    icon: "/img/svg/building.svg",
    title: "Contribute To projects",
    description:
      "Contribute to open source projects and learn from the CodersHub.",
  },
  {
    icon: "/img/svg/coding.svg",
    title: "Code Snippets",
    description: "Find and share code snippets with the CodersHub.",
  },
];
...
export default function Home() {
  ...
  return (
    <Layout
      ...
      description="Welcome to CodersHub. Learn the basics to advanced concepts of web development. html, css, javascript, react, node.js, dsa, and more."
    >
      {/* <HomepageHeader /> */}

      <main>
        <Hero
          title="Welcome To CodersHub"
        ...
        <div className={styles.home__divider}>
          <Heading as="h2">Features of CodersHub</Heading>
        </div>
