...
const PrivacyPolicy: React.FC = () => {
  return (
    <Layout
      ...
      description="Privacy Policy of CodersHub for CodersHub Learners, and users"
    >
      <PrivacyPolicyContainer>
        ...
        <Content>
          ...
          Welcome to{" "}
          <a
            href="https://www.linkedin.com/in/abhinavkt3/"
            target="_blank"
          ...
          <a
            href="mailto:abhinavkt120@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
          >
            {" "}
            abhinavkt120@gmail.com
          </a>
          . Thank you for visiting CodersHub!
        </Content>
      </PrivacyPolicyContainer>
    </Layout>
  );
