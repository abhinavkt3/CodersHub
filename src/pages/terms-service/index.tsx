...
const TermsOfService: React.FC = () => {
  return (
    ...
    description="Terms of Service Page for CodersHub Learners, and users"
    >
      <TermsContainer>
        <Title>Terms of Service</Title>
        <Content>
          These Terms of Service govern your use of <b><mark>CodersHub</mark></b>,
          provided by <Strong><mark>Abhinav Kumar</mark></Strong>. By accessing or using the Service,
